...
public class AudioConferenceTest
{

    @Mock
    private Intent mockIntent;
    @Mock
    private Activity_Agora_AudioConference mockActivity;
    @Mock
    ...
    @Spy
    @InjectMocks
    private Activity_Agora_AudioConference spyActivity;
    ...
    public void onCreateTest() {
        ...
        verify(spyActivity).setupVoiceSDKEngine();
    }
