...
public class EditPrescriptionFragment extends Fragment {
                ...
                myRef.child("Phar").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DataSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            ArrayList<String> availablePharmacies = getAvailablePharmacies(task, selectedDrugsPrescription);
    ...
    private ArrayList<String> getAvailablePharmacies(Task<DataSnapshot> task, Map<String, Integer> prescription){
        ...
        for (Map.Entry<String, Object> entryL1 : map.entrySet()) {
            ...
            for (Map.Entry<String, Integer> entry : prescription.entrySet()) {
                ...
                if(mapMedicine.containsKey(drug)){
